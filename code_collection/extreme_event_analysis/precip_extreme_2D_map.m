    ...
    if strfind(pwd_str, 'CESM')
        if DAILY
            ...
            quantile_file_r = '/net/aimsir/archive1/ziweili/CESM_LENS/output/precip_99.9th_quantile_r_daily_corrected.mat';
            ...
            quantile_file_r = '/net/aimsir/archive1/ziweili/CESM_LENS/output/precip_99.9th_quantile_r_corrected.mat';
            n = 1;
        end
    ...
    if HISTORICAL
        ...
        if strfind(pwd_str, 'CESM')
            ...
            %historical_precip_wrong = precip_with_mask_wrong_0218_2020(n, lon_indices, lat_indices, historical_files, MASK, h_max, ocean_only, p_mask);
