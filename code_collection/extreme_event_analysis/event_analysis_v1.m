...
function event_analysis_v1(box_min, box_max, p_min, p_max, lat_series_original, lon_series_original, lat_indices, lon_indices, ...
                ...
                for m = 1 : length(days_{jj, ii})
                    ...
                    if ~any(isnan(aaa(:)))
                        ...
                        for ji = 1 : temp_L^2
                            ...
                            temp_T = squeeze(T(indy - dL - 1 + j, indx - dL - 1 + i, :, 2));
