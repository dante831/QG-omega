...
temp = omega_h(:, :, plot_ind) .* NaN_matrix_d;
...
temp = omega_QG_h(:, :, plot_ind) .* NaN_matrix_d;
...
temp = d_k2(:, :, plot_ind) ./ Omega_QG_h_mean_d / delta_T .* NaN_matrix_d;
plot_title = '(a) $k$';
...
temp = d_l2(:, :, plot_ind) ./ Omega_QG_h_mean_d / delta_T .* NaN_matrix_d;
plot_title = '(b) $k_J$';
main_fig_2 = subplot_2D_map(...
...
temp = (omega_QG_r(:, :, plot_ind) - omega_QG_h(:, :, plot_ind)) ./ Omega_QG_h_mean_d / delta_T .* NaN_matrix_d;
...
temp = temp(:, :, plot_ind) / delta_T .* NaN_matrix_d;
plot_title = '(b) Approximate dry decomposition';
%plot_title = '(b) $\frac{\delta k_J^2}{k_J^2}-\frac{\delta k^2}{k^2}+\frac{\delta \overline{J}}{\overline{J}}-\frac{\delta \hat{\sigma}}{\hat{\sigma}}$';
main_fig_3 = subplot_2D_map(...
...
%print(main_fig_3.handle, figname, '-depsc', '-r0', '-painters')
